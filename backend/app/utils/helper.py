    ...
    try:
        ...
        for process in processes:
            ...
            for app in applications:
                if app and app.id and process.application_id and app.id == process.application_id:
                    process_data.update({
                        "name": app.name,
                        "vendor": app.vendor,
                        "version": app.version,
                ...
                for pe_file in pe_files:
                    if pe_file and pe_file.id and app.pe_file_id and pe_file.id == app.pe_file_id:
                        process_data.update({
